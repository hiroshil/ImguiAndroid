...
void ImguiEGL::ShowStyleEditor(ImGuiStyle* ref)
{
    ...
    if (ImGui::BeginTabBar("##tabs", ImGuiTabBarFlags_None))
    {
        if (ImGui::BeginTabItem("细节调整"))
        {
            ...
            ImGui::SliderFloat("滚动条大小", &style.ScrollbarSize, 1.0f, 100.0f, "%.0f");
            ImGui::SliderFloat("抓取器最小尺寸", &style.GrabMinSize, 1.0f, 100.0f, "%.0f");
            ImGui::Text("Borders");
            ...
            ImGui::SliderFloat("边框尺寸", &style.FrameBorderSize, 0.0f, 10.0f, "%.0f");
            ...
            ImGui::SliderFloat("滚动条调整", &style.ScrollbarRounding, 0.0f, 100.0f, "%.0f");
            ImGui::SliderFloat("抓取调整", &style.GrabRounding, 0.0f, 100.0f, "%.0f");
